Feature: Target overview
  ...
  Background:
    ...
    And I found target by name "Paper Cranes" on dashboard
  ...
  Scenario: Looking for Paper Cranes common target on dashboard
    ...
    And I should see small property "Target" with value "50 paper cranes"
    And I should see small property "For" with value Next 10 Days
